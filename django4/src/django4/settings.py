...
SECRET_KEY = '#ton*r-%g2m^f9zrks7sc8l)=d810aq37qbn-+3ufu+kw1it#('

# SECURITY WARNING: don't run with debug turned on in production!

#서버나 page not found 에러등이 안보이도록 개발자 모드 설ㅈ버 ㅇ변수
#Debug가 Ture : 개발자몯,
#Debug가 False : 배포모드(에러가 숨겨짐)
DEBUG = True
...
'''
#login_required 데코레이터가 비로그인 상태의 클라이언트에게 전달할
#로그인 페이지 주소
...
#ID와 보안 비밀을 저장하는 변수
SOCIAL_AUTH_GOOGLE_PLUS_KEY = '80304849642-ka56htovriim4jgnkk4ec5oph5fa9ooc.apps.googleusercontent.com'
SOCIAL_AUTH_GOOGLE_PLUS_SECRET = 'phBrZCL8n62HQ6iEngyRx6z1'
...
INSTALLED_APPS = [
    ...
    'vote',
    'customlogin',
    #social-auth-app-django를 설치했을 때 사용할수있는 어플리케이션
    #social_django : 소셜로그인 기능을 다루는 어플리케이션
    #소셜로그인 : 다른사이트에 회원정보를 우리 웹서버에 가져오는 방식
    'social_django',
    'blog'
]
...
#파일을 다운받을 수 있도록 설정
MEDIA_URL = '/files/'
#클라이언트가 파일요청시 웹서버의 프로젝트폴더/files/에서 파일을 꺼내옴
